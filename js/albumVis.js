...
class AlbumVis {
    ...
    initVis(){
        ...
        vis.albums = vis.svg.selectAll("image")
            .data(vis.albumData);
        
        vis.albums.enter().append("svg:image")
        ...
        vis.backGround = vis.svg.selectAll("rect")
            .data(vis.albumData);
        
        vis.backGround.enter().append("rect")
            .attr("x", d => vis.xScale(parseInt(d.place)) + 50)
            .attr("y", function(d, i) {
                if (i < 6) {
                    return vis.margin.top 
        ...
        vis.albumText = vis.svg.selectAll(".album-label")
            .data(vis.albumData);
        ...
        vis.yearText = vis.svg.selectAll(".year-label")
            .data(vis.albumData);
    ...
    updatePalette(d){
        ...
        d3.select("#title-header")
            .style("color", hexValues[0]);
